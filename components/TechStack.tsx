...
/* "Our tech stack": the twelve technologies as a three-column list with logos. Shared by the home page (/05) and the
   Services page ("Technologies we work with") so the two always show the same stack. `number` is the "/05"-style
   section label; leave it out where the section isn't numbered. */
export default function TechStack({ number, title, aside }: { number?: string; title: ReactNode; aside: ReactNode }) {
  return (
                    ...
                    <div className="mxd-section-title__data top-number">
                      <div className="mxd-section-title__number anim-uni-in-up">
                        <span className="title-number">
                          <SectionIcon />
                          <span className="mxd-scramble">{number}</span>
                        </span>
                      </div>
                    </div>
                  )}
          ...
          <div className="container-fluid p-0">
            <div className="row g-0">
              <div className="col-12 col-xl-4 mxd-aside-descr mxd-grid-item">
                <p className="t-bold t-large t-aside mxd-split-lines">{aside}</p>
              </div>
