...
// Run immediately if the document is already parsed by the time this script executes
// (e.g. when loaded via Next.js Script strategies), otherwise wait for DOMContentLoaded
// like the original template does.
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", mxdBaseInit);
} else {
  mxdBaseInit();
}
// --------------------------------------------- //
...
function pageAppearance() {
  ...
  // Wait for fonts before measuring/splitting lines, otherwise SplitText masks
  // against fallback-font metrics and GSAP warns "SplitText called before fonts loaded".
  document.fonts.ready.then(() => {
